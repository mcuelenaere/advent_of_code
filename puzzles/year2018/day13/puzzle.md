...
In this example, the location of the first crash is <code><em>7,3</em></code>.
...
After four very expensive crashes, a tick ends with only one cart remaining; its final location is <code><em>6,4</em></code>.
