...
This is tied with other routes as the _fastest way to reach the target_: <code><em>45</em></code> minutes. In it, `` 21 `` minutes are spent switching tools (three times, seven minutes each) and the remaining `` 24 `` minutes are spent moving.
