...
You still can't quite make out the details in the image. Maybe you just didn't <a href="https://en.wikipedia.org/wiki/Kernel_(image_processing)" target="_blank">enhance</a> it <span title="Yeah, that's definitely the problem.">enough</span>.

If you enhance the starting input image in the above example a total of _50_ times, <code><em>3351</em></code> pixels are lit in the final output image.
