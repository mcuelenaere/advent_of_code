from .shared import parse_instructions, Instruction, is_real_room
...
assert decrypt_name(Instruction(encrypted_name='qzmt-zixmtkozy-ivhz', sector_id=343, checksum='foobar')) == 'very encrypted name'
